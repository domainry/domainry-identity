...
func (Profile) MigrationRollbackPolicy() driver.MigrationRollbackPolicy {
	return driver.MigrationRollbackPolicy{Mode: "restore_sqlite_backup", RequiresVerifiedBackup: true, Procedure: []string{"stop_identity", "replace_database_with_latest_migration_backup", "restart_identity", "verify_migration_status"}}
}
...
func (Profile) AcquireMigrationLock(ctx context.Context, _ *sql.DB, _ ormdialect.Renderer, options driver.MigrationLockOptions) (driver.MigrationLock, error) {
