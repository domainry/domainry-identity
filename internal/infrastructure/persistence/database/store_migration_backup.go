...
func (s *IdentityStore) ensureMigrationBackupForExistingData(ctx context.Context, cfg config.Config) error {
...
func (s *IdentityStore) migrationBackupChecksum(path string) (string, error) {
...
func (s *IdentityStore) hasExistingApplicationData(ctx context.Context) (bool, error) {
...
func isMigrationSystemTable(name string) bool {
	...
	case "", "_identity_file_migrations", "_identity_schema_migrations":
		return true
	default:
		return false
	}
