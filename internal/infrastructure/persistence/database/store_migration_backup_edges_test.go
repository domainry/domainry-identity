...
func TestSQLiteMigrationBackupChecksumAndStatFailures(t *testing.T) {
	...
	store := &IdentityStore{db: db, dialect: sqlite.NewEngine(), backupChecksum: func(string) (string, error) { return "", errDatabaseSQL }}
...
func (dialect namedTestDialect) Name() string { return dialect.name }
