...
func TestIdentityOperationalMetricsExposeMigrationBackupAndRestoreState(t *testing.T) {
	...
	for _, expected := range []string{
		"domainry_identity_migration_duration_seconds_count 2",
		"domainry_identity_migration_failures_total 1",
		"domainry_identity_migration_lock_attempts_total 2",
		"domainry_identity_migration_lock_failures_total 1",
		"domainry_identity_migration_lock_wait_seconds_total 0.100000000",
		"domainry_identity_backup_age_seconds 3600.000000000",
		"domainry_identity_restore_drill_age_seconds 777600.000000000",
	} {
