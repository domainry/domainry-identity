...
func validBackupEvidence(now time.Time) BackupEvidence {
	return BackupEvidence{
		...
		Artifacts: []Artifact{
			{Kind: ArtifactDatabase, Checksum: "database", Size: 0},
			{Kind: ArtifactIdentityManifest, Checksum: "manifest", Size: 0},
			{Kind: ArtifactSigningKeyVersions, Checksum: "signing-keys", Size: 0},
			{Kind: ArtifactDataKeyVersions, Checksum: "data-keys", Size: 0},
			{Kind: ArtifactService, Checksum: "service", Size: 0},
		},
	}
}
