...
func standaloneProtocolAuthorizationActions() ([]identitymodel.IdentityActionDefinition, error) {
	...
	service := func(policy string) actioncontract.Authorization {
		...
		return actioncontract.Authorization{Strategy: actioncontract.AuthorizationServiceIdentity, PolicyKey: policy, Audiences: []string{"registered_identity_application"}}
	}
	operations := func(policy string) actioncontract.Authorization {
		return actioncontract.Authorization{Strategy: actioncontract.AuthorizationOperationsIdentity, PolicyKey: policy}
	}
	specs := []standaloneProtocolActionSpec{
		{key: "identity.health.live", owner: "identity:standalone", sourceKind: "health_probe", capabilityKey: "identity.health", capabilityLabel: "Identity health", operationKey: "live", operationLabel: "Liveness", label: "Read Identity liveness", method: http.MethodGet, route: "/live", exposure: actioncontract.ExposurePublic, authorization: anonymous("identity.health.live"), risk: actioncontract.RiskLow},
		{key: "identity.health.ready", owner: "identity:standalone", sourceKind: "health_probe", capabilityKey: "identity.health", capabilityLabel: "Identity health", operationKey: "ready", operationLabel: "Readiness", label: "Read Identity readiness", method: http.MethodGet, route: "/ready", exposure: actioncontract.ExposurePublic, authorization: anonymous("identity.health.ready"), risk: actioncontract.RiskLow},
		{key: "identity.health.get", owner: "identity:standalone", sourceKind: "health_probe", capabilityKey: "identity.health", capabilityLabel: "Identity health", operationKey: "get", operationLabel: "Health", label: "Read Identity health", method: http.MethodGet, route: "/health", exposure: actioncontract.ExposurePublic, authorization: anonymous("identity.health.get"), risk: actioncontract.RiskLow},

		{key: "identity.portability.write_fences.freeze", owner: "identity:portability", sourceKind: "operations_surface", capabilityKey: "identity.portability.write_fences", capabilityLabel: "Identity portability write fences", operationKey: "freeze", operationLabel: "Freeze", label: "Freeze workspace writes for portability", method: http.MethodPost, route: "/ops/identity-portability/write-fences", exposure: actioncontract.ExposureOps, authorization: operations("identity.portability.operations_token"), risk: actioncontract.RiskCritical},
		{key: "identity.portability.write_fences.release", owner: "identity:portability", sourceKind: "operations_surface", capabilityKey: "identity.portability.write_fences", capabilityLabel: "Identity portability write fences", operationKey: "release", operationLabel: "Release", label: "Release a workspace portability write fence", method: http.MethodPost, route: "/ops/identity-portability/write-fences/{workspaceID}/release", exposure: actioncontract.ExposureOps, authorization: operations("identity.portability.operations_token"), risk: actioncontract.RiskCritical},

		{key: "identity.remote.discovery.get", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.discovery", capabilityLabel: "Identity Remote SDK discovery", operationKey: "get", operationLabel: "Discover", label: "Read the Identity Remote SDK descriptor", method: http.MethodGet, route: "/identity/discovery", exposure: actioncontract.ExposurePublic, authorization: anonymous("identity.remote.discovery"), risk: actioncontract.RiskLow},
		{key: "identity.remote.application_service.token", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.application_service", capabilityLabel: "Identity application service", operationKey: "token", operationLabel: "Issue token", label: "Issue an application service token", method: http.MethodPost, route: "/identity/application-service/token", exposure: actioncontract.ExposurePublic, authorization: service("identity.application_service.static_credential"), risk: actioncontract.RiskHigh},
		{key: "identity.remote.application_service.verify", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.application_service", capabilityLabel: "Identity application service", operationKey: "verify", operationLabel: "Verify token", label: "Verify an application service token", method: http.MethodPost, route: "/identity/application-service/verify", exposure: actioncontract.ExposurePublic, authorization: service("identity.application_service.verifier_credential"), risk: actioncontract.RiskHigh},
		{key: "identity.remote.access_bundle.resolve", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.authorization", capabilityLabel: "Identity Remote SDK authorization", operationKey: "access_bundle", operationLabel: "Resolve access", label: "Resolve an access bundle for the authenticated subject", method: http.MethodPost, route: "/identity/access-bundle", exposure: actioncontract.ExposurePublic, authorization: principal, risk: actioncontract.RiskMedium},
		{key: "identity.remote.authorization.reauthorize", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.authorization", capabilityLabel: "Identity Remote SDK authorization", operationKey: "reauthorize", operationLabel: "Reauthorize", label: "Reauthorize an authenticated subject", method: http.MethodPost, route: "/identity/reauthorize", exposure: actioncontract.ExposurePublic, authorization: principal, risk: actioncontract.RiskMedium},
		{key: "identity.remote.applications.register", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.applications", capabilityLabel: "Identity application registry", operationKey: "register", operationLabel: "Register", label: "Register the calling application", method: http.MethodPut, route: "/identity/applications/current", exposure: actioncontract.ExposurePublic, authorization: service("identity.applications.application_credential"), risk: actioncontract.RiskHigh},
		{key: "identity.remote.permissions.reconcile", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.permissions", capabilityLabel: "Identity PermissionDefinition reconcile", operationKey: "reconcile", operationLabel: "Reconcile", label: "Reconcile source-owned PermissionDefinitions", method: http.MethodPut, route: "/identity/permissions/reconcile", exposure: actioncontract.ExposurePublic, authorization: service("identity.permissions.application_credential"), risk: actioncontract.RiskHigh},
		{key: "identity.remote.permissions.source_snapshot", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.permissions", capabilityLabel: "Identity PermissionDefinition reconcile", operationKey: "source_snapshot", operationLabel: "Read source snapshot", label: "Read the current source-owned PermissionDefinition snapshot hash", method: http.MethodPost, route: "/identity/permissions/source-snapshot", exposure: actioncontract.ExposurePublic, authorization: service("identity.permissions.application_credential"), risk: actioncontract.RiskLow, effect: actioncontract.EffectRead},

		{key: "identity.remote.directory.user.get", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.directory", capabilityLabel: "Identity directory projection", operationKey: "user_get", operationLabel: "Get user", label: "Read one user projection", method: http.MethodPost, route: "/identity/runtime/directory/user", exposure: actioncontract.ExposurePublic, authorization: service("identity.directory.application_credential"), risk: actioncontract.RiskLow},
		{key: "identity.remote.directory.department.get", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.directory", capabilityLabel: "Identity directory projection", operationKey: "department_get", operationLabel: "Get department", label: "Read one department projection", method: http.MethodPost, route: "/identity/runtime/directory/department", exposure: actioncontract.ExposurePublic, authorization: service("identity.directory.application_credential"), risk: actioncontract.RiskLow},
		{key: "identity.remote.directory.users.list", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.directory", capabilityLabel: "Identity directory projection", operationKey: "users_list", operationLabel: "List users", label: "List user projections", method: http.MethodPost, route: "/identity/runtime/directory/users", exposure: actioncontract.ExposurePublic, authorization: service("identity.directory.application_credential"), risk: actioncontract.RiskLow},
		{key: "identity.remote.directory.roles.list", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.directory", capabilityLabel: "Identity directory projection", operationKey: "roles_list", operationLabel: "List roles", label: "List role projections", method: http.MethodPost, route: "/identity/runtime/directory/roles", exposure: actioncontract.ExposurePublic, authorization: service("identity.directory.application_credential"), risk: actioncontract.RiskLow},
		{key: "identity.remote.directory.role_assignments.list", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.directory", capabilityLabel: "Identity directory projection", operationKey: "role_assignments_list", operationLabel: "List role assignments", label: "List user-role assignment projections", method: http.MethodPost, route: "/identity/runtime/directory/role-assignments", exposure: actioncontract.ExposurePublic, authorization: service("identity.directory.application_credential"), risk: actioncontract.RiskLow},
		{key: "identity.remote.directory.workforce.list", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.directory", capabilityLabel: "Identity directory projection", operationKey: "workforce_list", operationLabel: "List workforce", label: "List workforce projections", method: http.MethodPost, route: "/identity/runtime/directory/workforce", exposure: actioncontract.ExposurePublic, authorization: service("identity.directory.application_credential"), risk: actioncontract.RiskLow},
		{key: "identity.remote.principal.resolve", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.principal", capabilityLabel: "Identity principal projection", operationKey: "resolve", operationLabel: "Resolve", label: "Resolve a principal for a trusted Runtime", method: http.MethodPost, route: "/identity/runtime/principal/resolve", exposure: actioncontract.ExposurePublic, authorization: service("identity.principal.application_credential"), risk: actioncontract.RiskMedium},
