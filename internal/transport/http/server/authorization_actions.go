...
func standaloneProtocolAuthorizationActions() ([]identitymodel.IdentityActionDefinition, error) {
	...
	specs := []standaloneProtocolActionSpec{
		...
		{key: "identity.remote.directory.organization_unit.get", owner: "identity:remote-sdk", sourceKind: "remote_sdk_surface", capabilityKey: "identity.remote.directory", capabilityLabel: "Identity directory projection", operationKey: "organization_unit_get", operationLabel: "Get organization unit", label: "Read one organization unit projection", method: http.MethodPost, route: "/identity/runtime/directory/organization-unit", exposure: actioncontract.ExposurePublic, authorization: service("identity.directory.application_credential"), risk: actioncontract.RiskLow},
