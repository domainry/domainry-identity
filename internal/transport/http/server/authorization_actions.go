...
func standaloneProtocolAuthorizationActions() ([]identitymodel.IdentityActionDefinition, error) {
	...
	specs := []standaloneProtocolActionSpec{
		...
		{key: "identity.remote.workflow_workloads.apply", owner: "identity:remote-sdk", sourceKind: "remote_sdk_http", capabilityKey: "identity.remote.workflow_workloads", capabilityLabel: "Workflow workload identity", operationKey: "apply", operationLabel: "Apply release", label: "Atomically apply Workflow workload bindings", method: http.MethodPut, route: "/identity/workflow-workloads", exposure: actioncontract.ExposurePublic, authorization: service("identity.workflow_workload.application_credential"), risk: actioncontract.RiskHigh},
		{key: "identity.remote.workflow_workloads.resolve", owner: "identity:remote-sdk", sourceKind: "remote_sdk_http", capabilityKey: "identity.remote.workflow_workloads", capabilityLabel: "Workflow workload identity", operationKey: "resolve", operationLabel: "Resolve binding", label: "Resolve a Workflow workload binding", method: http.MethodPost, route: "/identity/workflow-workloads/resolve", exposure: actioncontract.ExposurePublic, authorization: service("identity.workflow_workload.application_credential"), risk: actioncontract.RiskMedium},
		...
		{key: "identity.remote.projection.display_names.resolve", owner: "identity:remote-sdk", sourceKind: "remote_sdk_http", capabilityKey: "identity.remote.projection", capabilityLabel: "Identity projection projection", operationKey: "display_names_resolve", operationLabel: "Resolve display names", label: "Resolve user and organization display names", method: http.MethodPost, route: "/identity/display-names/resolve", exposure: actioncontract.ExposurePublic, authorization: service("identity.projection.application_credential"), risk: actioncontract.RiskLow},
