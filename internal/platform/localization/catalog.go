...
import (
	...
	embeddedlocales "github.com/domainry/domainry-identity/internal/platform/localization/locales"
)
...
func loadCatalog() Catalog {
	...
	panic("no Identity locale TOML directory found or loadable; expected internal/platform/localization/locales or conf/locales; checked " + strings.Join(failures, " | "))
}
...
func localeDirCandidates() []string {
	...
	candidates := []string{
		filepath.Join("internal", "platform", "localization", "locales"),
		filepath.Join("internal", "runtime", "conf", "locales"),
