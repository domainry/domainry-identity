...
func MetadataDictionaryAuthoringCapabilities() []authoringcontract.CapabilityAuthoringDefinition {
	...
	return []authoringcontract.CapabilityAuthoringDefinition{{
		...
		ValidationEndpoint: "POST /metadata/definitions/dictionary/{resourceKey}/validate", ConfigurationRoutes: metadataConfigurationRoutes("dictionary"),
		...
		OutputVariables: []authoringcontract.CapabilityAuthoringOutput{{Name: "dictionary_key", JSONPointer: "/definition/resource_key", Type: "dictionary_key", VisibleTo: "subsequent_capability_calls"}, {Name: "schema_hash", JSONPointer: "/definition/schema_hash", Type: "schema_hash", VisibleTo: "subsequent_capability_calls"}},
		...
		Sources: []authoringcontract.CapabilityAuthoringSource{
			{Kind: "contract", Path: "internal/domain/metadata/contract/metadata_dictionary_authoring.go", Symbol: "MetadataDictionaryAuthoringCapabilities"},
			{Kind: "validation", Path: "internal/domain/metadata/validation/metadata_dictionary_validation.go", Symbol: "MetadataValidateDictionaryDefinition"},
