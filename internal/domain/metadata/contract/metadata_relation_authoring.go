...
func MetadataRelationAuthoringCapability() authoringcontract.CapabilityAuthoringDefinition {
	...
	return authoringcontract.CapabilityAuthoringDefinition{
		...
		ConfigurationRoutes:      metadataConfigurationRoutes("field"),
		...
		ReferenceContracts: []authoringcontract.CapabilityAuthoringReference{metadataObjectReference("/object_key"), metadataRelationTargetReference("/payload/config/target")},
		...
		Sources: []authoringcontract.CapabilityAuthoringSource{
			{Kind: "contract", Path: "internal/domain/metadata/contract/metadata_relation_authoring.go", Symbol: "MetadataRelationAuthoringCapability"},
			{Kind: "validation", Path: "internal/domain/metadata/validation/metadata_field_mutation_validation.go", Symbol: "MetadataNormalizeFieldMutation"},
