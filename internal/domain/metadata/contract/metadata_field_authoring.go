...
func MetadataFieldAuthoringCapability() authoringcontract.CapabilityAuthoringDefinition {
	...
	return authoringcontract.CapabilityAuthoringDefinition{
		...
		ReferenceContracts: []authoringcontract.CapabilityAuthoringReference{metadataObjectReference("/object_key")},
		...
		Sources: []authoringcontract.CapabilityAuthoringSource{
			{Kind: "contract", Path: "internal/domain/metadata/contract/metadata_field_authoring.go", Symbol: "MetadataFieldAuthoringCapability"},
