...
func (s *MetadataDictionaryDomainService) Items(ctx context.Context, repository metadatarepository.MetadataRepository, dictionaryKey, locale string, principal identitymodel.Principal) (metadatamodel.DictionaryItemsResult, bool, error) {
	if !principal.Known {
