...
type MetadataRepository interface {
	...
	CompleteDefinitionRefresh(ctx context.Context, scope identitymodel.SystemScope, resourceType, resourceKey, schemaVersion, schemaHash, errorText string) error
