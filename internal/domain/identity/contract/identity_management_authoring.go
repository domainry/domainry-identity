...
func IdentityUserAuthoringCapability() authoringcontract.CapabilityAuthoringDefinition {
	...
	return authoringcontract.CapabilityAuthoringDefinition{
		...
		Permissions: []string{"identity.users.write"}, AuditEvents: []string{"identity_user_created", "identity_user_updated"},
		...
		Execution:       identityManagementExecution([]string{"identity.user"}, "identity.user", "stable_user_id_upsert", "identity_user_updated", "identity.users.write"),
...
func IdentityDepartmentAuthoringCapability() authoringcontract.CapabilityAuthoringDefinition {
	...
	return authoringcontract.CapabilityAuthoringDefinition{
		...
		Permissions: []string{"identity.departments.write"}, AuditEvents: []string{"identity_department_created", "identity_department_updated"}, ValidationEndpoint: "POST /identity/departments/{departmentID}/validate",
		...
		Execution:          identityManagementExecution([]string{"identity.department"}, "identity.department", "stable_department_id_upsert", "identity_department_updated", "identity.departments.write"),
		Errors: []authoringcontract.CapabilityAuthoringError{
...
func IdentityUserRoleAssignmentAuthoringCapability() authoringcontract.CapabilityAuthoringDefinition {
	...
	return authoringcontract.CapabilityAuthoringDefinition{
		...
		Parameters: []authoringcontract.CapabilityAuthoringParameter{{Key: "role_id", Type: "string", Required: true}, {Key: "workforce_profile_id", Type: "string"}, {Key: "binding_key", Type: "string"}, {Key: "profile_id", Type: "string"}, {Key: "valid_from", Type: "string", Format: "date-time"}, {Key: "valid_until", Type: "string", Format: "date-time"}, {Key: "grant_reason", Type: "string"}, {Key: "expires_at", Type: "string", Format: "date-time"}}, Permissions: []string{"identity.roles.write"}, AuditEvents: []string{"identity_user_role_assigned", "identity_user_role_removed"},
		...
		Execution:          identityManagementExecution([]string{"identity.user", "identity.role"}, "identity.user_role_assignment", "stable_user_role_pair_upsert", "identity_user_role_assigned", "identity.roles.write"),
		Errors: []authoringcontract.CapabilityAuthoringError{
