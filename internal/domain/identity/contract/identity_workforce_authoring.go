...
func IdentityWorkforceProfileAuthoringCapability() authoringcontract.CapabilityAuthoringDefinition {
	...
	return authoringcontract.CapabilityAuthoringDefinition{
		...
		AuditEvents:              []string{"identity_workforce_profile_upserted"},
		...
		Execution:          identityManagementExecution([]string{"identity.user", "identity.workforce_profile"}, "identity.workforce_profile", "stable_workforce_profile_id_upsert", "identity_workforce_profile_upserted"),
...
func IdentityWorkforceAssignmentAuthoringCapability() authoringcontract.CapabilityAuthoringDefinition {
	...
	return authoringcontract.CapabilityAuthoringDefinition{
		...
		AuditEvents:              []string{"identity_workforce_assignment_upserted"},
		...
		Execution: identityManagementExecution([]string{"identity.workforce_profile", "identity.workforce_assignment", "identity.department"}, "identity.workforce_assignment", "stable_workforce_assignment_id_upsert", "identity_workforce_assignment_upserted"),
		Errors: []authoringcontract.CapabilityAuthoringError{
