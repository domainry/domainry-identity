...
func badRequest(code string, params ...string) error {
	return authDomainError(apperror.KindBadRequest, code, params...)
}

func forbidden(code string, params ...string) error {
	return authDomainError(apperror.KindForbidden, code, params...)
}

func notFound(code string, params ...string) error {
	return authDomainError(apperror.KindNotFound, code, params...)
}
...
func authDomainError(kind apperror.ErrorKind, code string, params ...string) error {
