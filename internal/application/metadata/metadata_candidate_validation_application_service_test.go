...
func loadMetadataCandidateFixture(t *testing.T) manifestmodel.ManifestSchema {
	...
	return manifestmodel.ManifestSchema{
		...
		Roles:   []identitymodel.RoleSchema{{Key: "admin", Name: "Admin", Permissions: []string{"identity.roles.list"}, RecordScope: "all_records", DataPermissions: []identitymodel.DataPermission{{ObjectKey: "customer", Scope: "all_records", Read: true, Write: true}}}},
	}
}
