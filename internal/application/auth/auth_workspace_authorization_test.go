...
func TestAuthApplicationAuthorizesWorkspaceBeforeRepositoryAccess(t *testing.T) {
	...
	principal := identitymodel.Principal{Known: true, UserID: "user", Role: identitymodel.RoleSchema{Permissions: identitymodel.RolePermissionsWithScope(identitymodel.IdentityDataScopeAll, "auth.reset_password")}}
